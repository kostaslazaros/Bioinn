  ...
  navbarPage(
    ...
    tabPanel(
      ...
      sidebarLayout(
        ...
        mainPanel(
          ...
          br(),
          br(),
          p("Single-cell RNA-sequencing (scRNA-seq) and RNA-sequencing (RNA-seq) have revolutionized the field of biomedical research,
          presenting both opportunities and computational analysis challenges. Dealing with the enormous complexity of data,
          especially in gene selection, remains a critical hurdle. Our platform, Bioinn,
          excels in identifying key genes within both scRNA-seq and RNA-seq datasets,
          leveraging more than 15 specialized feature extraction techniques.
          A unique aspect of Bioinn is its ensemble approach,
          allowing users to create their personalized method by selecting one technique from each category.
          This tool provides comprehensive analysis of prominent genes,
          evaluating their predictive accuracy and relevance to various biological processes and drug interactions.
          It also includes visual representations like KEGG pathways and PPI networks to give users a complete view of the gene functions.
          With its extensive features, Bioinn serves as an invaluable
          resource for discovering and deciphering transcriptional markers for complex diseases using scRNA-seq and RNA-seq research."),
          br(),
          br(),
          br(),
          div(
            ...
            p(
              a(
                href = "mailto:info@pytheia.gr", "Feel free to contact us for any issue or question at info@pytheia.gr",
    ...
    ")
      ...
      dropMenu(
        ...
        br(),
        p(
          "The Shiny app requires sequencing data in the form of read counts with annotations.
      The dataset needs to be formatted in a matrix with size NxE, with N samples and E-1 gene expressions (i.e. X(i,j) is the expression value of gene j for sample i).
      ...
      In this case, the exported potential biomarkers indicate the separability among all classes offering the interpretation that the reader considers. It operates more effectively if data are normalized, and the initial condition (sample classes)
      includes a binary case study (control - state) are computed.
...
"
      ...
      sidebarLayout(
        column(
          ...
          actionButton("click", "Run Analysis",
            style = "flex-start"
          ), # #position: absolute; right: -130px;  bottom: -85px
        ),
        column(
          2,
          offset = 2,
      ...
      dashboardSidebar(
        ...
        strong("Genes Selection Methods",
          style =
            "color:black"
        )
      ),
          ...
          column(
            ...
            column(
              ...
              radioButtons(
                ...
                "Heatmap Clustering:",
                choices = c(
                  "Between Groups" = "cluster_between_groups",
